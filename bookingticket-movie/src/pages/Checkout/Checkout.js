...
function Checkout(props) {
  ...
  // ban đầu chưa nhận được dữ liệu, giờ mún gọi API khi load trang web ban đầu gọi component Didmound hay nói cách khác gọi useEffect
  useEffect(() => {
  ...
  const renderSeats = () => {
    return danhSachGhe.map((ghe, index) => {
      ...
      // Kiểm tra từng render xem có phải khách đặt hay không
    ...
    <div className="container min-h-screen mt-5">
      <div className="grid grid-cols-12">
        ...
        <div className="col-span-3">
          ...
          <hr />
          <h3 className="text-xl mt-2 text-4xl">{thongTinPhim.tenPhim}</h3>
          <p>Địa điểm: {thongTinPhim?.tenRap}</p>
          <p>
          ...
          <div className="flex flex-row my-5">
            <div className="w-4/5">
              <span className="text-red-400 text-lg pr-2">Ghế</span>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Chú ý kiểm tra lại thông tin đặt vé và check lại địa điểm và thời
              gian bạn nhé !
            </p>
          </div>
